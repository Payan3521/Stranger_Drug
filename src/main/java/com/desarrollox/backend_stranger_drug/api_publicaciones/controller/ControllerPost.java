...
public class ControllerPost {
    ...
    @PostMapping
    public ResponseEntity<PostResponseDTO> savePost(@Valid @ModelAttribute PostDto postDto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PostResponseDTO> updatePost(@PathVariable Long id, @Valid @ModelAttribute PostDto postDto) {
